...
import { SiPolygon, SiEthereum,SiSolana,SiTether   } from "react-icons/si";
export function LoginCard() {
    return (
        <Card>
            <CardTitle className="text-center text-2xl">Looking for new Airdrop</CardTitle>
        ...
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                <Container className="h-10 w-10 circle-1">
                    <SiPolygon className="h-5 w-5 dark:text-purple-400" />
                </Container>
                <Container className="h-12 w-12 circle-2">
                    <SiEthereum className="h-8 w-8 dark:text-blue-500" />
                </Container>
                <Container className="h-20 w-20 circle-3">
                    <SiTether  className="h-12 w-12 dark:text-green-200" />
                </Container>
                <Container className="h-12 w-12 circle-4">
                    <BsCurrencyBitcoin className="w-8 h-8"/>
                </Container>
                <Container className="h-10 w-10 circle-5">
                    <SiSolana className="h-5 w-5 dark:text-purple-400" />
                </Container>
            </div>
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "max-w-lg  w-full mx-auto p-12 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
                className
            )}
        >
            {children}
