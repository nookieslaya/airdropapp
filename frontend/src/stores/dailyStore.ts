...
interface DailyStoreInterface {
    ...
    createSingleDailyTask: (e: React.FormEvent<HTMLFormElement>) => void
    updateSingleDailyTask: (e: React.FormEvent<HTMLFormElement>) => void
    deleteSingleDailyTask: (id: string) => void
}

const dailyStore = create<DailyStoreInterface>((set) => {
    return ({
        dailyTask: null,
